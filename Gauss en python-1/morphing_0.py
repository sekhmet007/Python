...
'''def calculate_pixel_color(img1, img2, point, transform1, transform2, alpha):
    ...
    interpolated_color = (1 - alpha) * np.array(color_start) + alpha * np.array(color_end)
...
def main():
    ...
    # assert len(points_koala) == 41, "Le nombre de points pour le koala n'est pas correct."
    # assert len(points_tigre) == 41, "Le nombre de points pour le koala n'est pas correct."
    ...
    # print("points_koala:")
    # for pts in points_koala:
    #     print(pts)

    # print("Triangles Tigre:")
    # for pts in points_tigre:
    #    print(pts)

    triangles_koala, triangles_tigre = read_triangles("triangles.txt", points_koala, points_tigre)
    # print(f"Nombre de triangles Koala lus : {len(triangles_koala)}")
    # print(f"Nombre de triangles Tigre lus : {len(triangles_tigre)}")
    # assert len(triangles_koala) == 72, "Le nombre de triangles pour le koala n'est pas correct."
    # assert len(triangles_tigre) == 72, "Le nombre de triangles pour le tigre n'est pas correct."
